...
public class ActivityTwo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			Log.i(TAG, "Entered the onCreate() savedInstanceNotNull mResume:"+mResume);
			...
			Log.i(TAG, "Entered the onCreate() savedInstanceNotNull 2 mResume:"+mResume);
	...
	public void onSaveInstanceState(Bundle savedInstanceState) {
		Log.i(TAG, "Entered On Save Instance State");
